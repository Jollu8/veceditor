...
public:
    ...
    /**
     * @brief Получить количество графических примитивов
     *
     * @return std::size_t
     */
    ...
    /**
     * @brief Создание графического примитива в фале
     *
    ...
    /**
     * @brief Метод для паттерна "посетитель"
     *
    ...
    /**
     * @brief Метод для начала сериализации (паттерн "посетитель")
     *
     * @param save
     */
    ...
    /**
     * @brief Метод ототри соки объектов редактора (паттерн "компоновщик")
     *
     */
    void draw() override
    {
    ...
    /**
     * @brief Метод пере индексации объектов после импорта
     *
...
public:
     ...
     *
     * @param cord Структура координат
     */
...
public:
    /**
     * @brief Метод начинающий сериализация объекта
     *
